...
//            recordatorio.setTitulo("Prueba David");
//            recordatorio.setDescripcion("Hola soy una prueba");
//            recordatorio.setFechaCreacion(java.time.Instant.now());
//            recordatorio.setUsuarioFk(entityManager.find(Usuario.class, 1)); // El entityManager asigna el recordatorio al usuario con id 2
